...
function TTestIPIDAddressSQLMapping.GenerateSelectStatement(const ABaseMap: TJCoreOPFMap): string;
begin
...
function TTestIPIDCitySQLMapping.GenerateSelectStatement(const ABaseMap: TJCoreOPFMap): string;
begin
